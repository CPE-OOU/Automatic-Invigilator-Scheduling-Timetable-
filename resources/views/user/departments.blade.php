                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $department->created_at->format('d/m/y') }}</span>
                                        </td>
                                        <td class="text-center">
                                            {{-- <a href="{{ route('departments.edit', $department->id) }}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit user">
...
<div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
    ...
    @endif
            <div class="modal-header">
                <h5 class="modal-title" id="addUserModalLabel">Add New Department</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="addUserForm" method="POST" action="{{ route('departments.index') }}">
                @csrf
