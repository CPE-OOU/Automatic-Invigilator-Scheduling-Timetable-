...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="">
          <img src="{{ asset('public/images/logo.png')}}" class="navbar-brand-img h-100" alt="logo">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('lecturers') ? 'active' : '') }}" href="{{ route('lecturers.index') }}">
              ...
              <span class="nav-link-text ms-1">Lecturers Management</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link " href="">
            ...
            <span class="nav-link-text ms-1">Payment Settings</span>
          </a>
        </li>
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        <div class="full-background" style="background-image: url('{{ asset('temp/assets/img/curved-images/white-curved.jpeg') }}');"></div>
        <div class="card-body text-start p-3 w-100">
            <div class="icon icon-shape icon-sm bg-white shadow text-center mb-3 d-flex align-items-center justify-content-center border-radius-md">
              <i class="ni ni-diamond text-dark text-gradient text-lg top-0" aria-hidden="true" id="sidenavCardIcon"></i>
            </div>
            <div class="docs-info">
                <a href="{{ route('home') }}" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Go Home</a>
            </div>
      </div>
    </div>
  </aside>
